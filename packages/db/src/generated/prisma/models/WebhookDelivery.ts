...
export type WebhookDeliveryWhereInput = {
  ...
  githubDeliveryId?: Prisma.StringFilter<"WebhookDelivery"> | string
...
export type WebhookDeliveryScalarWhereWithAggregatesInput = {
  ...
  githubDeliveryId?: Prisma.StringWithAggregatesFilter<"WebhookDelivery"> | string
...
export type WebhookDeliveryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"githubDeliveryId" | "event" | "action" | "payload" | "receivedAt", ExtArgs["result"]["webhookDelivery"]>
...
export interface WebhookDeliveryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `githubDeliveryId`
   * const webhookDeliveryWithGithubDeliveryIdOnly = await prisma.webhookDelivery.findMany({ select: { githubDeliveryId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many WebhookDeliveries and only return the `githubDeliveryId`
   * const webhookDeliveryWithGithubDeliveryIdOnly = await prisma.webhookDelivery.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more WebhookDeliveries and only return the `githubDeliveryId`
   * const webhookDeliveryWithGithubDeliveryIdOnly = await prisma.webhookDelivery.updateManyAndReturn({
   *   select: { githubDeliveryId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface WebhookDeliveryFieldRefs {
  readonly githubDeliveryId: Prisma.FieldRef<"WebhookDelivery", 'String'>
